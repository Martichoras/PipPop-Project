...
public class PinController : MonoBehaviour {
	...
	void OnCollisionEnter(Collision col){
		...
		if(col.gameObject.tag == "Pin"){ //if colliding object is of type 'Pin'
			Destroy(gameObject); //destroy this game object.
			//Debug.Log("Object destroyed!");
		} else if(col.gameObject.tag == "PipPopPin"){ // makes sure PipPopPin destroys this object. could be an || statement, but meh. I like spaghetti.
